...
public class AudioRecoderUtils {
    ...
    public AudioRecoderUtils(Context context) {
        ...
        this(context.getExternalFilesDir(Environment.DIRECTORY_PICTURES).getPath() + "/record/");
    }
    ...
    public void startRecord() {
        ...
        try {
            ...
            filePath = FolderPath + TimeUtil.getNow() + ".mp3";
            /* ③准备 */
    ...
    public long stopRecord() {
        ...
        /*if (endTime - startTime < 300) {
            audioStatusUpdateListener.onShort("录制时间太短！");
