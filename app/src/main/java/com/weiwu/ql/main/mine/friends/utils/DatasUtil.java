package com.weiwu.ql.main.mine.friends.utils;
...
import com.weiwu.ql.main.mine.friends.data.User;
...
public class DatasUtil {
    ...
    public static final User curUser = new User(UserInfo.getInstance().getUserId(), UserInfo.getInstance().getName(), UserInfo.getInstance().getAvatar());
    ...
    public static FavortItem createCurUserFavortItem() {
        FavortItem item = new FavortItem();
        item.setId(UserInfo.getInstance().getUserId());
