...
//        mTitleBar.getRightTitle().setTextColor(Color.BLUE);
        ...
        mTitleBar.setOnRightClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(mDeleteSelectItemListener!=null){
                    mDeleteSelectItemListener.select(mDelMembers);
                }
    ...
    private IDeleteSelectItemListener mDeleteSelectItemListener;

    public void setDeleteSelectItemListener(IDeleteSelectItemListener deleteSelectItemListener) {
        mDeleteSelectItemListener = deleteSelectItemListener;
    }

    public interface IDeleteSelectItemListener {
        void select(List<GroupMemberInfo> list);
    }
