...
public class GroupMemberInviteLayout extends LinearLayout implements IGroupMemberLayout {
    ...
    private ContactListData.DataDTO mList;
...
//        mTitleBar.getRightTitle().setTextColor(Color.BLUE);
        ...
        mTitleBar.setOnRightClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(mAddSelectItemListener!=null){
                    mAddSelectItemListener.select(mInviteMembers);
                }
    ...
    private IAddSelectItemListener mAddSelectItemListener;

    public void setAddSelectItemListener(IAddSelectItemListener addSelectItemListener) {
        mAddSelectItemListener = addSelectItemListener;
    }

    public interface IAddSelectItemListener {
        void select(List<String> list);
    }

    public void setDataSource(GroupInfo groupInfo, ContactListData.DataDTO list) {
        mGroupInfo = groupInfo;
        mList = list;
        if (mContactListView != null) {
            mContactListView.setGroupInfo(mGroupInfo);
            mContactListView.loadDataSource(ContactListView.DataSource.FRIEND_LIST, mList);
        }
    }
