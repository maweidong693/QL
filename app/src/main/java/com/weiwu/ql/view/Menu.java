        ...
        PopActionClickListener popActionClickListener = new PopActionClickListener() {
            ...
            public void onActionClick(int position, Object data) {
                ...
                if (TextUtils.equals(action.getActionName(), mActivity.getResources().getString(R.string.add_friend))) {
                    Intent intent = new Intent(MyApplication.mApplicationContext, AddMoreActivity.class);
...
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        if (menuType == MENU_TYPE_CONTACT) {
            ...
            action = new PopMenuAction();
            action.setActionName(mActivity.getResources().getString(R.string.scan_it));
            action.setIconResId(R.drawable.menu_scan_it);
            action.setActionClickListener(popActionClickListener);
            menuActions.add(action);
...
//            menuActions.add(action);
        ...
        action = new PopMenuAction();
        action.setActionName(mActivity.getResources().getString(R.string.create_group_chat));//实质是创建讨论组
...
//        menuActions.add(action);
    ...
    public void show() {
        ...
        mMenuWindow.setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.bg_menu_shape));
