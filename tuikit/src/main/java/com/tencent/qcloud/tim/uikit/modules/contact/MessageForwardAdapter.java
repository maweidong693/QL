...
public class MessageForwardAdapter extends RecyclerView.Adapter<MessageForwardAdapter.ViewHolder> {

    protected List<ContactItemBean> mData;
    protected LayoutInflater mInflater;
    private MessageForwardListView.OnSelectChangedListener mOnSelectChangedListener;
    private MessageForwardListView.OnItemClickListener mOnClickListener;

    private int mPreSelectedPosition;
    private boolean isSingleSelectMode;

    public MessageForwardAdapter(List<ContactItemBean> data) {
        this.mData = data;
        mInflater = LayoutInflater.from(TUIKit.getAppContext());
    }

    @Override
    public MessageForwardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MessageForwardAdapter.ViewHolder(mInflater.inflate(R.layout.contact_selecable_adapter_item, parent, false));
    }

    @Override
    public void onBindViewHolder(final MessageForwardAdapter.ViewHolder holder, final int position) {
...
//                GlideEngine.loadImage(holder.avatar, Uri.parse(contactBean.getAvatarurl()));
    ...
    @Override
    public void onViewRecycled(MessageForwardAdapter.ViewHolder holder) {
        if (holder != null) {
    ...
    public void setOnSelectChangedListener(MessageForwardListView.OnSelectChangedListener selectListener) {
        mOnSelectChangedListener = selectListener;
    }

    public void setOnItemClickListener(MessageForwardListView.OnItemClickListener listener) {
