...
public class ChatLayout extends AbsChatLayout implements GroupChatManagerKit.GroupNotifyHandler {
    ...
    public void setChatInfo(ChatInfo chatInfo) {
        ...
        if (isGroup) {
            ...
            loadApplyList();
            getTitleBar().getRightIcon().setImageResource(R.drawable.more);
...
//                ToastUtil.toastLongMessage("loadApplyList onError: " + errMsg);
    ...
    public interface OnMessageItemClickListener {
        void onMessageForwardClick( MessageInfo msg);

        void onMessageFavoritesClick(MessageInfo msg);

        void onMessageQuoteClick(MessageInfo msg);
    }
}
