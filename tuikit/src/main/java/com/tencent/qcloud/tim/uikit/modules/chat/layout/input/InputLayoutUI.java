...
abstract class InputLayoutUI extends LinearLayout implements IInputLayout {
     ...
     * 引用文本框
     */
    public TextView mQuoteContent;
    /**
     * 引用文本删除按钮
     */
    protected ImageView mDeleteQuoteBt;
...
//        mShortcutArea = findViewById(R.id.shortcut_area);
        ...
        mRlQuote = findViewById(R.id.rl_quote);
        mQuoteContent = findViewById(R.id.quote_content);
        mDeleteQuoteBt = findViewById(R.id.delete_quote);
    ...
    protected void assembleActions() {
        ...
        action = new InputMoreActionUnit();
        action.setIconResId(R.drawable.ic_more_business_card);
        action.setTitleId(R.string.business_card);
        action.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startSendIdCard();
    ...
    protected abstract void startSendIdCard();
