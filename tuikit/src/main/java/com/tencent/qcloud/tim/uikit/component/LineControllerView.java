...
public class LineControllerView extends LinearLayout {
    ...
    public LineControllerView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mIcon = ta.getResourceId(R.styleable.LineControllerView_src, mIcon);
            setUpView();
        } finally {
            ta.recycle();
        }
    ...
    private void setUpView() {
        ...
        mIconImg = findViewById(R.id.item_img);
        if (mIcon!=0){
            mIconImg.setImageResource(mIcon);
        ...
        mUnreadCountText = findViewById(R.id.msg_circle_total_unread);
        setCanNav(mIsJump);
    }
     ...
     * @param content 内容
     */
    public void setUnreadCount(String content){
        mUnreadCountText.setText(content);
        mUnreadCountText.setVisibility(VISIBLE);
    }
    /**
     * 清除消息提醒
     */
    public void setUnreadclear(){
        mUnreadCountText.setText("");
        mUnreadCountText.setVisibility(GONE);
    }
