...
public class YHandler {
     ...
     */
    public YHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public YHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public YHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
